...
class CreateGeneralDataView extends StatefulWidget {
  const CreateGeneralDataView({super.key});

  @override
  State<CreateGeneralDataView> createState() => _EventGeneralDataViewState();
}

class _EventGeneralDataViewState extends State<CreateGeneralDataView> {
