...
final lightTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    displayMedium: GoogleFonts.montserratAlternates(color: const Color(0xFF2f2778), fontWeight: FontWeight.bold),
    headlineSmall: GoogleFonts.montserratAlternates(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w500),
    headlineMedium: GoogleFonts.montserratAlternates(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),
    headlineLarge: GoogleFonts.montserratAlternates(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold),
  ),
